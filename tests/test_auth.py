...
class UserAuthTestcase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.post("/api/v1/auth/register",
                      data=json.dumps(dict(email="dmutush@live.com", username="daniel",
                                           password="12345678")), content_type="application/json")

        self.app.post("/api/v1/auth/register",
                      data=json.dumps(dict(email="kenmigoma@gmail.com", username="migoma",
                                           password="12345678")), content_type="application/json")
        self.app.post("/api/v1/auth/register",
                      data=json.dumps(dict(email="danielmutubait@gmail.com", username="mutuba",
                                           password="12345678")), content_type="application/json")

        self.user = self.app.post("/api/v1/auth/login",
                                 data=json.dumps(dict(username="daniel", password="12345678")),
                                 content_type="application/json")
        self.access_token = json.loads(self.user.data.decode())['access_token']

        self.user = self.app.post("/api/v1/auth/login",
                             data=json.dumps(dict(username="migoma", password="12345678")),
                             content_type="application/json")
    ...
    def test_user_register(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="mutubadan@live.com", username="mutush",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_password_length(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="dmutush@live.com", username="mutha",
                                                      password="123456")),
                                 content_type="application/json")
    ...
    def test_email_not_empty(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="", username="mutuba",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_username_not_empty(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="dmutuba@live.com", username="",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_user_register_whitespace(self):
        '''Test User Registration method'''
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="dmutush@live.com", username="dan iel",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_email_already_registered(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="danielmutubait@gmail.com", username="brendah",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_username_exists(self):
        ...
        response = self.app.post("/api/v1/auth/register",
                                 data=json.dumps(dict(email="kev@live.com", username="mutush",
                                                      password="12345678")),
                                 content_type="application/json")
    ...
    def test_wrong_password(self):
        ...
        response = self.app.post("/api/v1/auth/login",
                                 data=json.dumps(dict(username="daniel", password="123678")),
                                 content_type="application/json")
...
########################
    def test_change_missing_old_password(self):
            ...
            response = self.app.post("/api/v1/auth/change_password",
    ...
    def test_login_after_password_change(self):
        ...
        self.app.post("/api/v1/auth/change_password",
                      data=json.dumps(dict(old_password="12345678",
