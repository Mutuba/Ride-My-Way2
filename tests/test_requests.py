...
class RequestsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.post("/api/v1/rides",
                      data=json.dumps(dict(category="SUV", pick_up="Uthiru",
                                           drop_off="CBD", date_time="20th June 12.00 A.M", price="Ksh. 700")),
                      headers={
                          "Authorization": "Bearer {}".format(self.access_token),
                          "Content-Type": "application/json"
                          })

        self.dict = dict(category="Limousine", pick_up="Uthiru",
                                           drop_off="CBD", date_time="20th June 12.00 A.M", price="Ksh. 700")
